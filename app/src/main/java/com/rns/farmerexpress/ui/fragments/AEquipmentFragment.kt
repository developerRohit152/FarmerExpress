...
class AEquipmentFragment : Fragment() {
    private var _binding: FragmentAEquipmentBinding? = null
    lateinit var rvEquipment : RecyclerView
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAEquipmentBinding.inflate(inflater, container, false)
        val root: View = binding.root
        rvEquipment = binding.rvEquipment


        addImageSlider()
        addEquipmentPostData()
        return root
    ...
    private fun addEquipmentPostData() {
